...
const SecondarySideBar = () => {
  return (
    <div className='w-[85px] ml-[10px]'>
        <ul className='flex flex-col justify-center gap-3 mt-5'>
            <li className='flex flex-col items-center gap-2 text-[10px] font-semibold'> <img className='h-5 ' src={HOME_URL} alt="yt-shorts" /> Home</li>
